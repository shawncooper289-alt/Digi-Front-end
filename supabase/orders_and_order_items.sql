-- Run this in the Supabase SQL Editor for https://raxsxcmferydxllddeub.supabase.co.
-- Note: this references public.organizations(id). If that table does not exist yet,
-- create it first or remove the organization_id foreign key line before running.
